...
class OccFormerEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, bev_h, bev_w, pc_range=None, 
        ...
        ref_3d = self.get_reference_points(bev_h, bev_w, pc_range[5]-pc_range[2], num_points_in_pillar, '3d', device='cpu')

        self.register_buffer('ref_3d', ref_3d)
        
        ref_2d = self.get_reference_points(bev_h, bev_w, dim='2d', bs=1, device='cpu')
    ...
    def forward(self,
        ...
        ref_2d = self.ref_2d.clone().expand(bs, -1, -1, -1)
